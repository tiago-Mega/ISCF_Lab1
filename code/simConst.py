...
sim_drawing_itemcolors              =0x00020    # +3 values per item (each item has its own ambient color (rgb values)). Mutually exclusive with sim_drawing_vertexcolors 
...
sim_particle_points1        =0    # 6 values per point (pt1 and pt2. Pt1 is start position pt2-pt1 is the initial velocity vector). i Point is 1 pixel big. Only appearance is a point internally handled as a perfect sphere 
